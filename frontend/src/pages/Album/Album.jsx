...
return (
  <div className={styles.container}>
    ...
    <select onChange={(e) => setStatus(e.target.value)} className={styles.select} >
        ...
        <p>Categoria:</p>
    <select onChange={(e) => setCategoria(e.target.value)} className={styles.select} >
      ...
      <div key={categoria} className={styles.categoria}>
        ...
        <div className={styles.grid}>
          {figurinhas.map((figurinha) => {
            ...
            const raridadeClass = figurinha.raridade === 'Comum' ? styles.cardComum :
              figurinha.raridade === 'Rara' ? styles.cardRara : styles.cardLendaria

            return (
              <div key={figurinha.id} className={`${styles.card} ${raridadeClass}`}>
                {quantidade === 0 ? (
                  <>
                  ...
                  <>
                    {quantidade > 1 && <span className={styles.badge}>+{quantidade - 1}</span>}
